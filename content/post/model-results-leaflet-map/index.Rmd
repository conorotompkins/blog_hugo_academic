...
[Last Friday I posted a classification model](https://ctompkins.netlify.app/post/classifying-pittsburgh-city-boundary/) that attempted to identify which census tracts in Allegheny County fall within the border of the City of Pittsburgh. I used a variety of data from the US Census via `{tidycensus}`, and I intentionally did not train the model with any geographic data. I am more interested in which census tracts are more "city-like", regardless of their distance from the geographic center of the city.
