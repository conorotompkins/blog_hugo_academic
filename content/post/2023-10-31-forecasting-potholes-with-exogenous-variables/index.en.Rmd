...
This code simulates the forecast for various scenarious of precipitation. It extracts the 10%, 50%, and 90% percentiles of precipitation by month. Then it recalculates the lagged weather data with each of those percentiles. Then it forecasts each scenario with the `arima_exo_lag3` model.
```{r}
...
glimpse(fc_scenarios$scenario_low)
