...
title: "Mapping Pittsburgh Commuter Modes"
subtitle: "Bivariate Discretized Bins"
summary: ""
authors: [Conor Tompkins]
tags: []
categories: []
date: 2021-03-18T16:12:51-04:00
lastmod: 2021-03-18T16:12:51-04:00
featured: false
draft: false
...
transit_bivariate_geo <- tract_transit %>% 
  ...
  bi_class(x = drove_alone, 
           ...
           style = "fisher", 
           dim = 3) %>% 
  left_join(tract_transit %>% group_by(GEOID) %>% summarize(), 
            by = c("geoid" = "GEOID")) %>% 
  st_sf()
...
transit_bivariate_geo %>% 
  ...
  theme_ipsum(base_size = 15)
```
Note that the X and Y axes are independent.
